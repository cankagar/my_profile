export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-8 text-center sm:p-24">
      ...
      <div className="relative z-[-1] flex place-items-center before:absolute before:h-[300px] before:w-full before:-translate-x-1/2 before:rounded-full before:bg-gradient-radial before:from-white before:to-transparent before:blur-2xl before:content-[''] after:absolute after:-z-20 after:h-[180px] after:w-full after:translate-x-1/3 after:bg-gradient-conic after:from-sky-200 after:via-blue-200 after:blur-2xl after:content-[''] sm:before:w-[480px] sm:after:w-[240px] before:lg:h-[360px] my-32">
        <h1 className="text-6xl font-bold tracking-tight text-blue-600 sm:text-8xl">
          My Profile
        </h1>
      </div>
      ...
      <div className="mb-32 grid text-center lg:mb-0 lg:w-full lg:max-w-5xl lg:grid-cols-4 lg:text-left gap-4">
        ...
        >
          ...
          <p className="m-0 max-w-[30ch] text-sm opacity-50">
            Find in-depth information about me and my career.
          </p>
        </a>
        ...
        >
          ...
          <p className="m-0 max-w-[30ch] text-sm opacity-50">
            Learn about my recent projects!
          </p>
        </a>
